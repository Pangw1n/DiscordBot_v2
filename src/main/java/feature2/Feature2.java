				...
				else if (piece.isFirstMove() && toRow == fromRow && Math.abs(toCol - fromCol) == 2)
				{
					...
					if (direction == -1)
					{
						if (checkLine(board, fromRow, fromCol, 0, direction, 4))
						{
							...
							if (board[toRow][0].getColor() == piece.getColor() && board[toRow][0].getType() == PieceType.ROOK && board[toRow][0].isFirstMove())
							{
					...
					else
					{
						if (checkLine(board, fromRow, fromCol, 0, direction, 3))
						{
							...
							if (board[toRow][7].getColor() == piece.getColor() && board[toRow][7].getType() == PieceType.ROOK && board[toRow][7].isFirstMove())
							{
